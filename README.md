...
`dobySDT` is an ongoing project aimed at building a general Signal Detection Theory (SDT) modeling framework across languages. The computational backend will be implemented in C++, with user interfaces provided for both R and Python.
...
The current working title of the package is `dobySDT`. However, similar to how `yukiRL` was later renamed to `binaryRL`, the package name may change during development.
